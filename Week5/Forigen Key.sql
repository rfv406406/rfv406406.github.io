...
SELECT * FROM product INNER JOIN varient ON product.id=varient.product_id;
SELECT * FROM product LEFT JOIN varient ON product.id=varient.product_id;
SELECT * FROM product RIGHT JOIN varient ON product.id=varient.product_id;

ALTER TABLE varient ADD FOREIGN KEY(product_id) REFERENCES product(id);
